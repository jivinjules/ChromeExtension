...
window.onload = function () {
    ...
    $(document).ready(function () {
        var b = $('head').append(b); var c = document.getElementById('tippin-button');
        var d = c.dataset;
        c.innerHTML = "tippin.me";
        ...
        iframe.src = 'https://tippin.me/buttons/send-lite.php?u=' + attributes.dest; return iframe
    }
}